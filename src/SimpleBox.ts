...
declare module SimpleBox
{
    export class SimpleBox {
        ...
        public static create(content:String, buttons:SimpleBoxButton[], settings?:SimpleBoxSettings):SimpleBox;
        public static create(header:String, content:String, buttons:SimpleBoxButton[], settings?:SimpleBoxSettings):SimpleBox;
            ...
            var closeButtonMarkup = "";
                if (this.settings.closeButton)
                {
                    if (this.settings.closeButtonMarkup) {
                        closeButtonMarkup = options['closeButton'];
                    }
                    else
                    {
    ...
    class Modal
    {
        ...
        constructor(markup:String, sizeSettings:{})
        {
            this.modal = $(markup);
